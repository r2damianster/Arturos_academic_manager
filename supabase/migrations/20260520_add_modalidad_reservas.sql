-- Modalidad de tutoría: presencial, virtual u otro
-- Link Zoom opcional (solo cuando es virtual)

ALTER TABLE public.reservas
  ADD COLUMN IF NOT EXISTS modalidad TEXT NOT NULL DEFAULT 'presencial'
    CHECK (modalidad IN ('presencial', 'virtual', 'otro')),
  ADD COLUMN IF NOT EXISTS link_zoom TEXT DEFAULT NULL;

-- Actualizar RPC para aceptar modalidad y link_zoom
