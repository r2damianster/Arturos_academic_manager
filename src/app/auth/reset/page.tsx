    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-1 text-sm">Recuperar contraseña</p>
        </div>

        <div className="card space-y-4">
          {sent ? (
            <div className="bg-emerald-950 border border-emerald-800 text-emerald-400 text-sm px-4 py-4 rounded-lg text-center leading-relaxed">
