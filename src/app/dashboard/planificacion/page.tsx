...
export default async function PlanificacionPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-4">
      <div>
        <h1 className="text-2xl font-bold text-white">Planificación Semanal</h1>
        <p className="text-gray-400 text-sm mt-1">Planifica y realiza seguimiento de tus clases</p>
      </div>
