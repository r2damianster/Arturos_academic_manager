    ...
    >
      ...
      >
        <div className="flex items-center justify-between mb-5">
          ...
          <button
            onClick={onClose}
            className="text-gray-400 hover:text-gray-200 transition-colors text-xl leading-none p-1"
          >
            ×
          </button>
        </div>
  ...
  return (
    <>
      ...
      <div className="space-y-4">
        ...
        {/* Grid o estado vacío con filtros */}
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {cursosFiltrados.map(curso => (
              <div key={curso.id} className="card relative group/card hover:border-gray-700 transition-colors">
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0">
                      ...
                      <h3 className="font-semibold text-gray-200 group-hover:text-white transition-colors truncate pr-8">
                        {curso.asignatura}
                      </h3>
                      {curso.fecha_inicio && (
                ...
                {/* Botón editar — aparece al hacer hover sobre la tarjeta */}
                <button
                  onClick={() => setCursoEditando(curso)}
                  className="absolute bottom-3 right-3 p-1.5 rounded-lg text-gray-600 hover:text-gray-200 hover:bg-gray-700 opacity-0 group-hover/card:opacity-100 transition-all"
                  title="Editar curso"
                >
